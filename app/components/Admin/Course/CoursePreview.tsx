...
type Props = {
    ...
    isEdit?: boolean; //will be used for editing the created course
}
//creating-data
  ...
  return (
    <div className="w-[90%] m-auto py-5 mb-5">
        <div className="w-full relative">
            ...
            <div className="flex items-center">
                <div className={`${styles.button} !w-[180px] my-3 font-Poppins !bg-[crimson] cursor-not-allowed`}>Buy Now {courseData?.price}$</div>
            </div>
            <br />
            <div className="flex items-center">
                <input type="text" name="" id="" placeholder="Discount Code..." className={`${styles.input} 1500px:!w-[50%] 1100px:!w-[60%] ml-3 !mt-0`} />
                <div className={`${styles.button} !w-[120px] my-3 ml-4 font-Poppins cursor-pointer`}>Apply</div>
            </div>
            <br />
        ...
        <div className="w-full">
            <div className="w-full 800px:pr-5">
                ...
                <div className="flex items-center justify-between pt-1">
                    <div className="flex items-center">
                        <Ratings rating={0}/> {/* component created in the 98th step */}
                        <h5>0 Reviews</h5>
                    </div>
                    <h5>0 Students</h5>
                </div>
            ...
            {courseData?.prerequisits?.map((item:any, index:number) => (
                <div className="w-full flex 800px:items-center py-2" key={index}>
                    <div className="w-[15px] mr-1">
                        <IoCheckmarkDoneOutline size={20}/>
                    </div>
            ...
            <div className="w-full">
                ...
                <p className="text-[18px] mt-[10px] whitespace-pre-line w-full overflow-hidden">{courseData?.description}</p>
            </div>
            <br />
            <br />
        </div>
