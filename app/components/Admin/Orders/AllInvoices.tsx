...
const AllInvoices = ({isDashboard}: Props) => {
  ...
  const columns:any = [
    ...
    ...(isDashboard ? [{field:"created_at", headerName:"Created At", flex:0.5}] : [{field:" ", headerName:"Email", flex:0.2, renderCell: (params:any) => {return (<a href={`mailto:${params.row.userEmail}`}><AiOutlineMail className="dark:text-white text-black" size={20}/></a>)}}])
  ]
  const rows:any = [
    {
        id:"1234567890",
        userName: "Sahil Akhtar",
        userEmail: "dedicatedgamer59@gmail.com",
            ...
            isLoading ? (<Loader />) :(
                <Box m={isDashboard ? "0" : "40px"}>
                    <Box m={isDashboard ? "0" : "40px 0 0 0"} height={isDashboard ? "35vh" : "90vh"} overflow={"hidden"} sx={{
                        ...
                        <DataGrid rows={rows} columns={columns} components={isDashboard ? {} : {Toolbar: GridToolbar}} />
                    </Box>
                </Box>
            )
        }
...
//OVER: 129("c": ../Widgets & ../Widgets/DashboardWidgets.tsx and "m": ../Widgets/DashboardWidgets.tsx) 