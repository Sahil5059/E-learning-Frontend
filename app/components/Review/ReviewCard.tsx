  ...
  return (
    <div className="w-full h-max pb-4 dark:bg-slate-500 dark:bg-opacity-[0.20] border border-[#00000028] dark:border-[#ffffff1d] backdrop-blur shadow-[bg-slate-700] rounded-lg p-3 shadow-inner">
        <div className="flex w-full">
            <Image src={props.item.avatar} alt='' width={50} height={50} className="w-[50px] h-[50px] rounded-full object-cover" />
            {/* watch- 25:00 to 26:10 */}
        ...
        <p className="pt-2 px-2 font-Josefin text-[17px] text-black dark:text-white">{props.item.comment}</p>
    </div>
  )
}
//exporting-data
