...
const CourseContent = ({id,user}: Props) => {
  ...
  return (
    //first, create a file named "./CourseContentMedia.tsx", code in it and then come back
    <>
        {
            isLoading ? (<Loader />) : (
                <>
                    ...
                    <div className="w-full grid 800px:grid-cols-10">
                        <Heading title={data[activeVideo]?.title} description="anything" keywords={data[activeVideo]?.tags} />
